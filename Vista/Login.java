...
import static Vista.MainMenu.jLabel_username;
...
public class Login extends javax.swing.JFrame {
    //data access object del usuario
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        /**
         * habilitar acciones posibles para un usuario
         * de tipo Cuentadante
         */
        if ("Cuentadante".equals(ue.getTipo())) {
            MainMenu.jMenuRegistrarUsuario.setEnabled(false);
            MainMenu.jMenuItemControlUsuario.setEnabled(false);
            MainMenu.jMenu7.setEnabled(false);
            MainMenu.jMenuItemControlMunicipios.setEnabled(false);
            MainMenu.jMenu8.setEnabled(false);
            MainMenu.jMenuItemControlConvocatoria.setEnabled(false);
        ...
        /**
         * habilitar acciones posibles para un usuario
         * de tipo Fiscal General
         */
        if ("Fiscal General".equals(ue.getTipo())) {
            MainMenu.jMenuRegistrarUsuario.setEnabled(false);
            MainMenu.jMenuItemControlUsuario.setEnabled(false);
            MainMenu.jMenu7.setEnabled(false);
            MainMenu.jMenuItemControlMunicipios.setEnabled(false);
        ...
        /**
         * mostrar en pantalla el nombre del usuario
         * luego de hcae login
         */
        jLabel_username.setText("Bienvenido: "+ue.getNombre());
        uid = ue.getId();
        ut = ue.getTipo();
    ...
    public void validar() throws ClassNotFoundException{
        ...
        /**
         * validaciones de campo del formulario
         */
        if(usernameLogin.getText().trim().isEmpty() && password.getText().trim().isEmpty() ){
           ...
           usernameLogin.requestFocus();
            ...
            if (ue.getNombre() == null &&
                ...
                /**
                 * Accion a tomar cuando el usuario introduzca 
                 * los valores correcto para poder hacer login.
                 * Abrir la ventana del Main Menu y
    ...
    /**
     * Reniciar el texto de la etiqueta del campo "username"
     * coloca un valor en blanco
     * @param evt 
     */
    ...
    /**
     * Reniciar el texto de la etiqueta del campo "password"
     * coloca un valor en blanco
     * @param evt 
     */
